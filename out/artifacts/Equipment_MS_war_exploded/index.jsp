...
<div id="container">
  ...
  <form action="${pageContext.request.contextPath }/AdminServlet">
    ...
    <input type="radio" name="type1" value="manager">管理员
    <select id="manager_select" name="type2">
      <option value="equit_manager">设备管理员</option>
      <option value="analy_manager">分析员</option>
      <option value="maintain_manager">维修员</option>
      <option value="buyer_manager">采购员</option>
    </select>
    <input type="radio" name="type1" value="user">访客
