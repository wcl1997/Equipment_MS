...
<frameset rows="70,*" frameborder=0 border="0" framespacing="0">
    ...
    <frameset cols="250,*" frameborder="0" border="0"  framespacing="10">
        ...
        <frame src="${pageContext.request.contextPath }/admin/left4.jsp" name="leftFrame"  scrolling="NO">

        <frame src="${pageContext.request.contextPath }/EquipmentServlet?action=getEquipmentsByEstate" name="mainFrame" >
