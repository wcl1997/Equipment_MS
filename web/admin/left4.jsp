...
<ul>
    <li><a href="${pageContext.request.contextPath }/EquipmentServlet?action=getEquipmentsByDisAgree" target="mainFrame"><i></i>驳回处理</a></li>
    <li><a href="${pageContext.request.contextPath }/EquipmentServlet?action=getEquipmentsByCheck" target="mainFrame"><i></i>审核成功</a></li>
    <li><a href="${pageContext.request.contextPath }/EquipmentServlet?action=getEquipmentsByEstate" target="mainFrame"><i></i>设备分析</a></li>
</ul>
