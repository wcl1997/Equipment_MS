...
<body style="background: #f3f3f3;">
	...
	<div class="main_top">
		<div class="am-cf am-padding am-padding-bottom-0">
			<div class="am-fl am-cf">
				<strong class="am-text-primary am-text-lg">设备管理</strong><small></small>
			</div>
		</div>
		<hr>
		<div class="am-g">
	...
	<div class="goods_list">
		...
		<ul class="list_goods_ul">
			...
			<li><a href="${ctx }/EquipmentServlet?action=editUI&id=${equipment.id}"><img class="img_icon" src="${ctx }/admin/images/edit_icon.png" ></a></li>
			<li><a href="${ctx }/EquipmentServlet?action=delEquipment&id=${equipment.id}"><img class="img_icon" src="${ctx }/admin/images/delete_icon.png"></a></li>
		</ul>
		</c:forEach>
