...
<div class="goods_list">
    ...
    <c:forEach items="${equipments }" var="equipment" varStatus="status">
        ...
        <ul class="list_goods_ul">
            ...
            <li><a href="${ctx }/AnalyServlet?action=repair&id=${equipment.id}" style="color: #00CC99">维修</a></li>
            <li><a href="${ctx }/AnalyServlet?action=scrap&id=${equipment.id}" style="color: #FF0066">报废</a></li>
        </ul>
    </c:forEach>
