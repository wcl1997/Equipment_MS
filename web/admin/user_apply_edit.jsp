...
<div class="am-cf am-padding am-padding-bottom-0">
    <div class="am-fl am-cf"><strong style="color: #0e90d2">修改租借信息</strong><small></small></div>
</div>
<hr>

<div style="margin:50px auto;width:300px;height:100px">
    <form action="${ctx }/LoanServlet?action=edit" method="post" id="add_form" style="background: none; width: 750px;">
        <span style="color:red">${err }</span>
        <input type="text"  name="id" value="${loan.id }" style="display:none">
